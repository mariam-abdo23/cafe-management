  ...
  return (
    <div className="p-6 min-h-screen bg-gradient-to-br from-[#fdf6f0] to-[#fff]">
      <div className="max-w-3xl mx-auto">
        <h2 className="text-4xl mt-32 font-bold text-center text-[#4e342e] mb-10">
          📅 My Shifts
        </h2>

        {shifts.length === 0 ? (
          <p className="text-center text-gray-600 text-lg">No shifts assigned yet.</p>
        ) : (
            ...
            {shifts.map((shift, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-3 text-[#6d4c41] mb-2">
                  ...
                  <span className="text-sm font-medium">Date: {shift.date}</span>
                </div>
                ...
                <div className="flex items-start gap-3 text-[#6d4c41] mt-4">
                  ...
                  <div>
                    <p className="text-sm font-medium mb-1">Co-workers:</p>
